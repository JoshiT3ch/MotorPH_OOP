public abstract class Employee {
    ...
    public double getPhilhealthDeduction() {
        return calculatePhilhealthDeduction(hoursWorked);
    }

    public double getPagibigDeduction() {
        return calculatePagibigDeduction(hoursWorked);
    }

    public double getTaxDeduction() {
        return calculateTaxDeduction(hoursWorked);
    }
    ...
    public final void printPayroll() {
